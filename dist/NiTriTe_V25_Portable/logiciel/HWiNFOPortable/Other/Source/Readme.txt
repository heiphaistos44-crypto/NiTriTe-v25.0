...
user in an INI file next to HWiNFOPortable.exe called HWiNFOPortable.ini.
...
copy AppNamePortable.ini from this directory to HWiNFOPortable.ini next to
HWiNFOPortable.exe. The options in the INI file are as follows:
